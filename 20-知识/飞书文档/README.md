...
> ⚠️ 本目录存放从飞书云文档批量抓取的**原始 Markdown 文件**，属于源材料（raw source），不属于已整理知识。
> 
> 这些文档已于 2026-07-30 批量导入，关键内容已提取到以下位置：
> - [[../智能体与知识库搭建/智能体验收方法论]] — 从验收/问题反馈中提炼
> - [[../业务拆解方法/业务需求拆解与AI切入点]] — 从项目日志中提炼
> - [[10-项目/宏昊AI助手]] — 四批次验收+问题汇总
> - [[10-项目/ProcurementAnalysis]] — 采购助手开发历程
> - [[10-项目/shippiing_helper]] — shipping-helper 开发历程
> - [[工作全景图_肖聪_202604-07]] — 工作全景
> - [[工作大事记_2026Q2]] — 里程碑时间线
...
| 文件名 | 类型 | 已提取至 |
|--------|------|----------|
| 07_monthly_report.md | 7月工作总结 | 全景图/大事记/项目笔记 |
...
| shipping_log.md | shipping-helper项目日志 | 业务拆解/shippiing_helper |
