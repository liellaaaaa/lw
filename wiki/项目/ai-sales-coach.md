...
# ai-sales-coach · AI 销售陪练 / 培训 Web 应用

## 项目简介

基于大模型的**销售培训 / 陪练** Web 应用：把企业的销售资料（文档、话术、产品知识）沉淀为**知识库**，结合 LLM 为销售员提供培训模拟、知识检索与陪练对话，并配套仪表盘、设置与鉴权。定位是「销售团队的内部 AI 教练」，用 RAG + LLM 把静态销售资料变成可交互的训练与问答能力。

## 接手背景

本人（肖聪，AI 技术专员）于 **2026 年 7 月中旬**正式接手 / 负责本项目。此前（4–6 月）知识库中出现的 `ai-sales-coach` 相关记录属前期阶段，**本笔记聚焦本人接手后的内容**，不把项目写成"从 4 月就一直在做"的悠久历史。
